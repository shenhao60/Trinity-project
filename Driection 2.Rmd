...
pacman::p_load(tidyverse,DBI,RSQLite,lubridate,rtweet,tidytext,lubridate,rjson,plotly,pacman,tmap,sp,cartogram)
...
tweetsGeo_plot <- ggplot()+
  geom_polygon(tweetsGeo, mapping=aes(x=lng, y=lat), fill=cut)+
